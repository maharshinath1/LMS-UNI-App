	...
	return (
		<div className="flex h-screen bg-gray-100 dark:bg-gray-900">
			...
			<div className="flex-1 flex flex-col items-center justify-start p-6 overflow-auto">
				{/* Intro/Info Card */}
				<div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mt-4 mb-8" id="ecollab-intro">
				...
				<div className="w-full max-w-6xl flex flex-col md:flex-row gap-8">
					...
					<div className="flex-1">
						<div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-6 mb-6">
							...
							<div className="space-y-6" data-tour="ecollab-posts">
								{posts.map(post => (
					...
					<div className="w-full md:w-72 flex-shrink-0 flex flex-col gap-6">
						<div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-5" data-tour="quick-links">
						...
						<div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-5" data-tour="highlights">
